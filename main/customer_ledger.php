...
include('../connect.php');
$tftft=$_GET['cname'];
$resulta = $dbh->prepare("SELECT * FROM sales WHERE invoice_number= :a");
...
$resultas = $dbh->prepare("SELECT * FROM customer WHERE customer_name= :b");
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				$tftft=$_GET['cname'];
				$result = $dbh->prepare("SELECT * FROM collection WHERE name= :userid ORDER BY transaction_id ASC");
