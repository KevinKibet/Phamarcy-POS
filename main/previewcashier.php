...
include('../connect.php');
$result = $dbh->prepare("SELECT * FROM sales WHERE invoice_number= :userid");
...
<?php include('navfixed.php');?>
	...
	<div class="span2">
			...
			<li class="active"><a href="salescashier.php?id=cash&invoice"><i class="icon-shopping-cart icon-2x"></i> Sales</a>  </li>             
	...
	<div class="span10">
	<a href="salescashier.php?id=cash&invoice=<?php echo $finalcode ?>"><button class="btn btn-default"><i class="icon-arrow-left"></i> Back to Sales</button></a>
...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	...
	<div>
	<?php
	$resulta = $dbh->prepare("SELECT * FROM customer WHERE customer_name= :a");
