...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
            ...
            <li class="active"><a href="manageusers.php"><i class="icon-user icon-2x"></i> Manage Users</a>
			              </li>
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			...
			All Users:  <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $rowcount;?>]</font>
			</div>
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			...
			<th width="13%"> User Email </th>
			<th width="7%"> Mobile Number</th>
			<th width="10%">Position </th>
			<th width="6%"> Registration Date </th>
	...
	<tbody>
			...
			<td><?php echo $row['UserMobileNumber']; ?></td>
